...
Widget _buildQuestionTypes(BuildContext context) {
  ...
  final localizations = AppLocalizations.of(context)!;
  final types = [
    (LucideIcons.circle_dot, localizations.questionTypeSingleChoice),
    (LucideIcons.square_check, localizations.questionTypeMultipleChoice),
    (LucideIcons.toggle_left, localizations.questionTypeTrueFalse),
    (LucideIcons.file_text, localizations.questionTypeEssay),
  ];
